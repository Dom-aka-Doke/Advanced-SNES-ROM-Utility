...
namespace Advanced_SNES_ROM_Utility
{
    public partial class frmCompanyName : Form
    {
        ...
        public frmCompanyName(byte[] sourceROM, byte[] sourceROMSMCHeader, uint romHeaderOffset, string title, byte[] byteTitle, string version, byte country, string company, int intROMSize, int calcFileSize, string romSavePath, string romName, bool isBSROM)
        {
            InitializeComponent();
