...
namespace Advanced_SNES_ROM_Utility
{
    public partial class FormMain : Form
    {
        ...
        private void RefreshLabelsAndButtons()
        {
            ...
            if (!_sourceROM.IsInterleaved && (_sourceROM.ByteMapMode == (byte)MapMode.lorom_1 || _sourceROM.ByteMapMode == (byte)MapMode.lorom_2 || _sourceROM.ByteMapMode == (byte)MapMode.hirom_1 || _sourceROM.ByteMapMode == (byte)MapMode.hirom_2 || _sourceROM.ByteMapMode == (byte)MapMode.hirom_spc7110)) { buttonConvertMapMode.Enabled = true; } else { buttonConvertMapMode.Enabled = false; }
            ...
            if (!_sourceROM.IsInterleaved && (_sourceROM.ByteMapMode == (byte)MapMode.hirom_1 || _sourceROM.ByteMapMode == (byte)MapMode.hirom_2 || _sourceROM.ByteMapMode == (byte)MapMode.hirom_spc7110 || _sourceROM.ByteMapMode == (byte)MapMode.exhirom_1 || _sourceROM.ByteMapMode == (byte)MapMode.exhirom_2)) { buttonInterleave.Enabled = true; buttonDeinterleave.Enabled = false; } else { buttonInterleave.Enabled = false; }
